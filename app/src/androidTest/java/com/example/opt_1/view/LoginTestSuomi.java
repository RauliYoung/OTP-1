...
public class LoginTestSuomi {
    ...
    @Test
    public void loginTestSuomi() throws InterruptedException {
        ...
        ViewInteraction materialButton = onView(
                allOf(withId(R.id.loginButton), withText("Kirjaudu"),
                        childAtPosition(
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.logOut_Button), withText("Kirjaudu Ulos"),
                        childAtPosition(
