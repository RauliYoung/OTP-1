...
public class LoginPageinEstonianTest {
    ...
    @Test
    public void loginPageinEstonianTest() throws InterruptedException {
        ...
        ViewInteraction materialButton = onView(
                allOf(withId(R.id.loginButton), withText("Logi Sisse"),
                        childAtPosition(
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.logOut_Button), withText("Logi välja"),
                        childAtPosition(
