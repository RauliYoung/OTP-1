...
public class LoginTestPersian {
    ...
    @Test
    public void loginTestPersian() throws InterruptedException {
        ...
        ViewInteraction materialButton = onView(
                allOf(withId(R.id.loginButton), withText("ورود"),
                        childAtPosition(
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.logOut_Button), withText("خروج"),
                        childAtPosition(
